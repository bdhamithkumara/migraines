...
export default function LandingPage() {
    ...
    return (
      <Grid
        ...
        alignItems="center"
      >
        <Grid item alignContent="center" mx="auto" style={{ textAlign: "center" }}>
          <h1>Track your migraines, help doctors find a cure</h1>
          <p style={{ maxWidth: "650px", lineHeight: "1.45" ,justifyContent:"center", alignItems:"center" , paddingLeft:"auto", paddingRight:"auto"}}>
